/******************************************************************************
 *  Compilation:  javac BinaryFileIn.java
 *  Execution:    java BinaryFileIn < input > output
 *  Dependencies: none             
 *  
 *  Supports reading binary data from standard input.
 *
 *  % java BinaryFileIn < input.jpg > output.jpg
 ...
 *  byte first) order.
 *  <p>
 *  The client should not intermix calls to {@code BinaryFileIn} with calls
 ...
 *  @author Kevin Wayne
 */
public final class BinaryFileIn {
    private static final int EOF = -1;      // end of file

    private static BufferedInputStream in;  // input stream
    private static int buffer;              // one character buffer
    private static int n;                   // number of bits left in buffer
    private static boolean isInitialized;   // has BinaryFileIn been called for first time?

    // don't instantiate
    private BinaryFileIn() { }
   ...
   /**
    ...
    public static void close() {
        ...
        try {
            ...
            throw new IllegalStateException("Could not close BinaryFileIn", ioe);
        }
    }
